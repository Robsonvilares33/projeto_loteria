#!/usr/bin/env python3
"""
Conferência do concurso 7047
Resultado: 06, 11, 26, 50, 61 (10/06/2026)
"""

import json
import os

# Resultado oficial do concurso 7047
...
def main():
    print("=" * 70)
    print("CONFERÊNCIA CONCURSO 7047")
    print("=" * 70)
    print(f"\n Resultado: {RESULTADO_7047}")
    print(f" Data: 10/06/2026")
    print()
    ...
    if games_56:
        ...
        acertos_56 = check_games(games_56_nums, RESULTADO_7047)
        ...
        for game in games_56:
            ...
            matches = len(set(game_nums) & set(RESULTADO_7047))
            if matches >= 3:
    ...
    if games_70:
        ...
        acertos_70 = check_games(games_70_nums, RESULTADO_7047)
